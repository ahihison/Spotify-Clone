    ...
    <div>
      <Dialog.Root open={isOpen} onOpenChange={onChange} defaultOpen={isOpen}>
        <Dialog.DialogPortal>
          ...
          <Dialog.Content
            className="fixed drop-shadow-sm border
            border-neutral-700 top-[50%] left-[50%]
            max-h-full h-full md:h-auto md:max-h-[85vh] w-full md:w-[90vw] md:max-w-[450px] translate-x-[-50%] translate-y-[-50%]
          ...
          >
            ...
            <Dialog.Description className="text-center  mb-5 leading-normal text-sm">
              {description}
            </Dialog.Description>
            <div>{children}</div>
